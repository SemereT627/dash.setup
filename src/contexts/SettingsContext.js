...
function SettingsProvider({ children }) {
  const [settings, setSettings] = useLocalStorage("settings", {
    themeMode: INITIAL_STATE.themeMode,
    themeDirection: INITIAL_STATE.themeDirection,
    themeColor: INITIAL_STATE.themeColor,
    themeStretch: INITIAL_STATE.themeStretch,
  });
